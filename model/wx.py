...
def feature_selection( x, c, s, names, sel_f_num,cancer_type): 
    if cancer_type == 'BLCA':
        step1_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,730,730,names,[], 0, 'top', div_ratio = 4)
        step2_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,365,1095,step1_sel_idx,step1_sel_idx, 0, 'top', div_ratio = 4)
        sel_f_num_write = len(step2_sel_idx)
        step3_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,200,1825,step2_sel_idx,step1_sel_idx[step2_sel_idx], sel_f_num_write, 'top', div_ratio = 4)
        final_sel_idx = step1_sel_idx[step2_sel_idx[step3_sel_idx]]
    if cancer_type == 'BRCA':
        step1_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,2555,2555,names,[], 0, 'top', div_ratio = 4)
        step2_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,2190,2920,step1_sel_idx,step1_sel_idx, 0, 'top', div_ratio = 4)
        sel_f_num_write = len(step2_sel_idx)
        step3_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,1095,3285,step2_sel_idx,step1_sel_idx[step2_sel_idx], sel_f_num_write, 'top', div_ratio = 4)
        final_sel_idx = step1_sel_idx[step2_sel_idx[step3_sel_idx]]
    if cancer_type == 'LUAD':
        step1_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,1095,1095,names,[], 0, 'top', div_ratio = 4)
        step2_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,730,1460,step1_sel_idx,step1_sel_idx, 0, 'top', div_ratio = 4)
        sel_f_num_write = len(step2_sel_idx)
        step3_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,365,1825,step2_sel_idx,step1_sel_idx[step2_sel_idx], sel_f_num_write, 'top', div_ratio = 4)
        final_sel_idx = step1_sel_idx[step2_sel_idx[step3_sel_idx]]
    if cancer_type == 'HNSC':
        step1_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,912,912,names,[], 0, 'top', div_ratio = 4)
        step2_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,548,1278,step1_sel_idx,step1_sel_idx, 0, 'top', div_ratio = 4)
        sel_f_num_write = len(step2_sel_idx)
        step3_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,365,1460,step2_sel_idx,step1_sel_idx[step2_sel_idx], sel_f_num_write, 'top', div_ratio = 4)
        final_sel_idx = step1_sel_idx[step2_sel_idx[step3_sel_idx]]
    if cancer_type == 'KIRC':
        step1_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,1825,1825,names,[], 0, 'top', div_ratio = 4)
        step2_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,1095,2190,step1_sel_idx,step1_sel_idx, 0, 'top', div_ratio = 4)
        sel_f_num_write = len(step2_sel_idx)
        step3_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,365,2920,step2_sel_idx,step1_sel_idx[step2_sel_idx], sel_f_num_write, 'top', div_ratio = 4)
        final_sel_idx = step1_sel_idx[step2_sel_idx[step3_sel_idx]]        
    if cancer_type == 'LGG':
        step1_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,1460,1460,names,[], 0, 'top', div_ratio = 4)
        step2_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,730,2190,step1_sel_idx,step1_sel_idx, 0, 'top', div_ratio = 4)
        sel_f_num_write = len(step2_sel_idx)
        step3_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,548,2555,step2_sel_idx,step1_sel_idx[step2_sel_idx], sel_f_num_write, 'top', div_ratio = 4)
        final_sel_idx = step1_sel_idx[step2_sel_idx[step3_sel_idx]]        
    if cancer_type == 'LUSC':
        step1_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,1095,1095,names,[], 0, 'top', div_ratio = 4)
        step2_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,730,1460,step1_sel_idx,step1_sel_idx, 0, 'top', div_ratio = 4)
    ...
    if cancer_type == 'SKCM':
        step1_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,1825,1825,names,[], 0, 'top', div_ratio = 4)
        step2_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,1460,2190,step1_sel_idx,step1_sel_idx, 0, 'top', div_ratio = 4)
        sel_f_num_write = len(step2_sel_idx)
        step3_sel_idx = get_wx_sel_idx(x, c, s,cancer_type,1095,2555,step2_sel_idx,step1_sel_idx[step2_sel_idx], sel_f_num_write, 'top', div_ratio = 4)
        final_sel_idx = step1_sel_idx[step2_sel_idx[step3_sel_idx]]
...
def merge144(sel_merge_idx,sel_500_idx,n_feature):
...
def merge196(sel_merge_idx,sel_500_idx,n_feature):
